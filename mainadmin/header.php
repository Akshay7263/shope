  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="shopreq.php"><i class="fa fa-shopping-cart"></i><span>View/Edit request</span></a></li>
        
        <li><a href="customeradd.php"><i class="fa fa-user"></i><span>Add Product</span></a></li>
